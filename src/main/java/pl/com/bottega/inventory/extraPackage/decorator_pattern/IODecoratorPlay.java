...
public class IODecoratorPlay {
    ...
    public static void main(String[] args) throws IOException {
        OutputStream outputStream = new FileOutputStream("C:\\Users\\bartek\\IdeaProjects\\inventory_test\\src\\main\\java\\pl\\com\\bottega\\inventory\\extraPackage\\decorator_pattern\\test.txt");
        int k = 200;
